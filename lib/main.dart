...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //key nya jangan lupa di ganti yah

  void _onTap() async {
    var client = http.Client();
    try {
      var param = {"q": _lokasi, "appid": "07820575830587bf6695d17e3da1d4a7"};
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.network(
                        'https://play-lh.googleusercontent.com/KdG0SFetNB2YAacnE29wAN4baBHRE0AV9bGINfXyFA22Xqf0Ehu-GWMeAAkiOF7uGMUe',
                        width: 60,
                        height: 60,
                        fit: BoxFit.fitWidth,
                      ),
